...
let cAndorra = wrd.cAnd + bas.cor + bas.cra; // Andorra
...
let cBarbados = bas.cBa + bas.crb + wrd.c1a1d + bas.cos; // Barbados
...
let cBurundi = bas.cBu + wrd.crun + bas.cdi; // Burundi
...
let cCanada = wrd.cCan + phn.cada; // Canada
let cCentralAfricanRepublic = wrd.cCentral + bas.cSpace + wrd.cAfrican + bas.cSpace + wrd.cRepublic; // Central African Republic
...
let cCostaRica = wrd.cCost + bas.ca + bas.cSpace + bas.cR + phn.cica; // Costa Rica
...
let cDemocraticRepublicOfTheCongo = wrd.cDemocratic + bas.cSpace + wrd.cRepublic + bas.cSpace + bas.cof + bas.cSpace + wrd.cthe + bas.cSpace + cCongo; // Democratic Republic of the Congo
let cDenmark = bas.cDe + phn.cnmar + bas.ck; // Denmark
let cDjibouti = bas.cDj + bas.cib + wrd.cout + bas.ci; // Djibouti
...
let cKuwait = bas.cKu + wrd.cwait; // Kuwait
...
let cLithuania = wrd.cLit + bas.chu + phn.cania; // Lithuania
...
let cNepal = bas.cNe + wrd.cpal; // Nepal
let cNetherlands = bas.cNe + phn.cther + bas.cla + phn.cnds; // Netherlands
let cNewZealand = wrd.cNew + bas.cSpace + bas.cZe + phn.cala + bas.cnd; // New Zealand
...
let cPalau = wrd.cPal + bas.cau; // Palau
let cPalestine = wrd.cPal + phn.cest + phn.cine; // Palestine
let cPanama = bas.cPa + phn.cnam + bas.ca; // Panama
let cPapuaNewGuinea = wrd.cPapua + bas.cSpace + wrd.cNew + bas.cSpace + cGuinea; // Papua New Guinea
...
let cPortugal = wrd.cPort + bas.cug + bas.cal; // Portugal
let cPrincipe = phn.cPri + bas.cnc + bas.cip + bas.ce; // Principe
let cQatar = bas.cQa + phn.ctar; // Qatar
let cRomania = bas.cRo + wrd.cman + bas.cia; // Romania
...
let cSuriname = bas.cSu + bas.cri + wrd.cname; // Suriname
...
let cTrinidadAndTabago = wrd.cTrinidad + bas.cSpace + wrd.cand + bas.cSpace + wrd.cTabago; // Trinidad and Tabago
...
let cUnitedArabEmirates = wrd.cUnited + bas.cSpace + wrd.cArab + bas.cSpace + wrd.cEmirates; // United Arab Emirates
let cUnitedKingdom = wrd.cUnited + bas.cSpace + bas.cKi + bas.cng + phn.cdom; // United Kingdom
let cUnitedStatesOfAmerica = wrd.cUnited + bas.cSpace + wrd.cStates + bas.cSpace + bas.cof + bas.cSpace + wrd.cAmerica; // United States Of Ammerica
