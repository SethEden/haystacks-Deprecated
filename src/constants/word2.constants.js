...
// String Numbers
export const czero = bas.cze + bas.cro; // zero
export const cZero = bas.cZe + bas.cro; // Zero
export const cone = bas.co + bas.cne; // one
export const ctwo = bas.ct + bas.cwo; // two
export const cthree = bas.ct + phn.chree; // three
export const cfour = bas.cf + phn.cour; // four
export const cfive = bas.cf + phn.cive; // five
export const csix = bas.cs + bas.cix; // six
export const cseven = bas.cs + phn.ceven; // seven
export const ceight = bas.ce + phn.cight; // eight
export const cnine = bas.cn + phn.cine; // nine
export const cten = bas.ct + bas.cen; // ten
export const celeven = bas.ce + phn.cleven; // eleven
export const ctwelve = bas.ct + phn.cwelve; // twelve
export const cthirteen = bas.ct + phn.chir + phn.cteen; // thirteen
export const cfourteen = cfour + phn.cteen; // fourteen
export const cfifteen = bas.cf + bas.cif + phn.cteen; // fifteen
export const csixteen = csix + phn.cteen; // sixteen
export const cseventeen = cseven + phn.cteen; // seventeen
export const ceighteen = bas.ce + phn.cigh + phn.cteen; // eighteen
export const cnineteen = cnine + phn.cteen; // nineteen
export const ctwenty = bas.ct + phn.cwenty; // twenty
export const cthirty = bas.ct + phn.chirty; // thirty
export const cfourty = cfour + bas.cty; // fourty
export const cfifty = bas.cf + phn.cifty; // fifty
export const csixty = csix + bas.cty; // sixty
export const cseventy = cseven + bas.cty; // seventy
export const ceighty = ceight + bas.cy; // eighty
export const cninety = cnine + bas.cty; // ninety
export const chundred = bas.ch + phn.cundred; // hundred
export const cthousand = bas.ct + phn.chousand; // thousand
export const cmillion = bas.cm + phn.cillion; // million
export const cbillion = bas.cb + phn.cillion; // billion
export const ctrillion = bas.ctr + phn.cillion; // trillion
export const cOne = bas.cO + bas.cne; // One
export const cTwo = bas.cT + bas.cwo; // Two
export const cThree = bas.cT + phn.chree; // Three
export const cFour = bas.cF + phn.cour; // Four
...
export const cFourth = cFour + bas.cth; // Fourth
export const cfifth = bas.cfi + bas.cft + bas.ch; // fifth
export const cFifth = bas.cFi + bas.cft + bas.ch; // Fifth
export const csixth = csix + bas.cth; // sixth
export const cSixth = cSix + bas.cth; // Sixth
export const cseventh = cseven + bas.cth; // seventh
export const cSeventh = cSeven + bas.cth; // Seventh
export const ceighth = ceight + bas.ch; // eighth
export const cEighth = cEight + bas.ch; // Eighth
export const ctenth = cten + bas.cth; // tenth
export const cTenth = cTen + bas.cth; // Tenth
export const celeventh = celeven + bas.cth; // eleventh
export const cEleventh = cEleven + bas.cth; // Eleventh
export const ctwelveth = ctwelve + bas.cth; // twelveth
export const cTwelveth = cTwelve + bas.cth; // Twelveth
export const cthirteenth = cthirteen + bas.cth; // thirteenth
export const cThirteenth = cThirteen + bas.cth; // Thirteenth
export const cfourteenth = cfourteen + bas.cth; // fourteenth
export const cFourteenth = cFourteen + bas.cth; // Fourteenth
export const cfifteenth = cfifteen + bas.cth; // fifteenth
export const cFifteenth = cFifteen + bas.cth; // Fifteenth
export const csixteenth = csixteen + bas.cth; // sixteenth
export const cSixteenth = cSixteen + bas.cth; // Sixteenth
export const cseventeenth = cseventeen + bas.cth; // seventeenth
export const cSeventeenth = cSeventeen + bas.cth; // Seventeenth
export const ceighteenth = ceighteen + bas.cth; // eighteenth
export const cEighteenth = cEighteen + bas.cth; // Eighteenth
export const cnineteenth = cnineteen + bas.cth; // nineteenth
export const cNineteenth = cNineteen + bas.cth; // Nineteenth
export const ctwentieth = bas.ctw + bas.cen + phn.ctieth; // twentieth
export const cTwentieth = bas.cTw + bas.cen + phn.ctieth; // Twentieth
export const cthirtieth = bas.cth + bas.cir + phn.ctieth; // thirtieth
export const cThirtieth = bas.cTh + bas.cir + phn.ctieth; // Thirtieth
export const cfourtieth = cfour + phn.ctieth; // fourtieth
export const cFourtieth = cFour + phn.ctieth; // Fourtieth
export const cfiftieth = bas.cfi + bas.cf + phn.ctieth; // fiftieth
export const cFiftieth = bas.cFi + bas.cf + phn.ctieth; // Fiftieth
export const csixtieth = csix + phn.ctieth; // sixtieth
export const cSixtieth = cSix + phn.ctieth; // Sixtieth
export const cseventieth = cseven + phn.ctieth; // seventieth
export const cSeventieth = cSeven + phn.ctieth; // Seventieth
export const ceightieth = ceight + phn.cieth; // eightieth
export const cEightieth = cEight + phn.cieth; // Eightieth
export const cninetieth = cnine + phn.ctieth; // ninetieth
export const cNinetieth = cNine + phn.ctieth; // Ninetieth
export const chundredth = chundred + bas.cth; // hundredth
export const cHundredth = cHundred + bas.cth; // Hundredth
export const cthousandth = cthousand + bas.cth; // thousandth
export const cThousandth = cThousand + bas.cth; // Thousandth
export const cmillionth = cmillion + bas.cth; // millionth
export const cMillionth = cMillion + bas.cth; // Millionth
export const cbillionth = cbillion + bas.cth; // billionth
export const cBillionth = cBillion + bas.cth; // Billionth
export const ctrillionth = ctrillion + bas.cth; // trillionth
export const cTrillionth = cTrillion + bas.cth; // Trillionth
// *************************************************************
...
// Operating Systems
export const cwin32 = phn.cwin + c3 + c2;
...
export const cmes = bas.cme + bas.cs; // mes
...
// Miscelanious
export const cUTF8 = bas.cUT + bas.cF + c8; // UTF8
...
export const cProcessing = cProcess + phn.cing; // Processing
export const cPROCESSING = cPROCESS + phn.cING; // PROCESSING
export const ccomplete = ccom + bas.cp + phn.clete; // complete
export const cComplete = cCom + bas.cp + phn.clete; // Complete
...
export const cAssertNotExists = cAssert + cNot + cExists; // AssertNotExists
export const cAssertValueEqual = cAssert + cValue + cEqual; // AssertValueEqual
export const cAssertValueNotEqual = cAssert + cValue + cNot + cEqual; // AssertValueNotEqual
...
export const cPrimary = phn.cPri + phn.cmary; // Primary
export const csecondary = csecond + phn.cary; // secondary
export const cSecondary = cSecond + phn.cary; // Secondary
...
export const cLine = bas.cLi + bas.cne; // LinecWithout
export const cdocument = cdoc + bas.cu + phn.cment; // document
export const cDocument = cDoc + bas.cu + phn.cment; // Document
...
export const cDeep = bas.cD + phn.ceep; // Deep
export const cclone = bas.ccl + cone; // clone
export const cClone = bas.cCl + cone; // Clone
...
export const cPatterns = cPattern + bas.cs; // Patterns
export const ccoma = ccom + bas.ca; // coma
export const cComa = cCom + bas.ca; // Coma
...
export const cPeriod = phn.cPer + phn.ciod; // Period
export const ccannot = ccan + cnot; // cannot
export const cCannot = cCan + cnot; // Cannot
export const cnothing = cnot + phn.ching; // nothing
export const cNothing = cNot + phn.ching; // Nothing
...
export const cCentral = cCent + phn.cral; // Central
...
export const cCountries = cCount + phn.cries; // Countries
export const cknot = bas.ck + cnot; // knot
export const cKnot = bas.cK + cnot; // Knot
...
export const cSynchronously = cSynchronous + bas.cly; // Synchronously
export const cappend = capp + cend; // append
export const cAppend = cApp + cend; // Append
...
export const cDot = bas.cDo + bas.ct; // Dot
export const clogic = clog + bas.cic; // logic
export const cLogic = cLog + bas.cic; // Logic
...
export const cApple = cApp + bas.cle; // Apple
...
export const cMiller = cMill + bas.cer; // Miller
...
export const cIndian = cIndia + bas.cn; // Indian
...
export const cminimum = cmin + phn.cimum; // minimum
export const cMinimum = cMin + phn.cimum; // Minimum
export const cminimums = cminimum + bas.cs; // minimums
export const cMinimums = cMinimum + bas.cs; // Minimums
export const cmaximum = cmax + phn.cimum; // maximum
export const cMaximum = cMax + phn.cimum; // Maximum
export const cmaximums = cmaximum + bas.cs; // maximums
export const cMaximums = cMaximum + bas.cs; // Maximums
export const cMaya = cMay + bas.ca; // Maya
...
export const cMinion = cMin + phn.cion; // Minion
...
export const cVeronese = phn.cVer + cone + bas.cse; // Veronese
export const cPapaya = cPapa + bas.cya; // Papaya
...
export const cPicotee = cPico + phn.ctee; // Picotee
...
export const cQuinacridone = bas.cQu + phn.cina + bas.ccr + bas.cid + cone; // Quinacridone
...
export const cRobin = bas.cRo + cbin; // Robin
...
export const cSandy = cSan + bas.cdy; // Sandy
