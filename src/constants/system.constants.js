...
export const cAsyncSingular = wr1.cAsync + wr1.cSingular; // AsyncSingular
export const cSyncSingular = wr1.cSync + wr1.cSingular; // SyncSingular
...
export const csmuggleSomething = wr1.csmuggle + bas.cSpace + wr1.csomething; // smuggle something
...
export const cSystemConstantsPathActual = wr1.csrc + bas.cForwardSlash + wr1.cconstants + bas.cForwardSlash; // src/constants/
...
export const cFunctionConstantsValidation = wr1.cFunction + wr1.cConstants + wr1.cValidation; // FunctionConstantsValidation
...
export const cWord1ConstantsValidation = wr1.cWord + num.c1 + wr1.cConstants + wr1.cValidation; // Word1ConstantsValidation
export const cWord2ConstantsValidation = wr1.cWord + num.c2 + wr1.cConstants + wr1.cValidation; // Word2ConstantsValidation
...
// Constants Filenames
export const cbasic_constants_js = wr1.cbasic + bas.cDot + wr1.cconstants + gen.cDotjs; // basic.constants.js
export const cbusiness_constants_js = wr1.cbusiness + bas.cDot + wr1.cconstants + gen.cDotjs; // business.constants.js
export const ccolor_constants_js = wr1.ccolor + bas.cDot + wr1.cconstants + gen.cDotjs; // color.constants.js
export const ccommand_constants_js = wr1.ccommand + bas.cDot + wr1.cconstants + gen.cDotjs; // command.constants.js
export const cconfiguration_constants_js = wr1.cconfiguration + bas.cDot + wr1.cconstants + gen.cDotjs; // configuration.constants.js
export const cconstant_constants_js = wr1.cconstant + bas.cDot + wr1.cconstants + gen.cDotjs; // constant.constants.js
export const ccountry_constants_js = wr1.ccountry + bas.cDot + wr1.cconstants + gen.cDotjs; // country.constants.js
export const cfunction_constants_js = wr1.cfunction + bas.cDot + wr1.cconstants + gen.cDotjs; // function.constants.js
export const celement_constants_js = wr1.celement + bas.cDot + wr1.cconstants + gen.cDotjs; // element.constants.js
export const cgeneric_constants_js = wr1.cgeneric + bas.cDot + wr1.cconstants + gen.cDotjs; // generic.constants.js
export const cisotope_constants_js = wr1.cisotope + bas.cDot + wr1.cconstants + gen.cDotjs; // isotope.constants.js
export const cknot_constants_js = wr1.cknot + bas.cDot + wr1.cconstants + gen.cDotjs; // knot.constants.js
export const clanguage_constants_js = wr1.clanguage + bas.cDot + wr1.cconstants + gen.cDotjs; // language.constants.js
export const cmessage_constants_js = wr1.cmessage + bas.cDot + wr1.cconstants + gen.cDotjs; // message.constants.js
export const cnumeric_constants_js = wr1.cnumeric + bas.cDot + wr1.cconstants + gen.cDotjs; // numeric.constants.js
export const cphonic_constants_js = wr1.cphonic + bas.cDot + wr1.cconstants + gen.cDotjs; // phonic.constants.js
...
export const cframeworkConstantsPath = wr1.cconstants + bas.cDoubleForwardSlash; // constants//
