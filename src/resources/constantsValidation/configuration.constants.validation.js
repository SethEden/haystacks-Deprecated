...
export const configurationConstantsValidation = [
  ...
  {Name: 'cenableBusinessRulePerformanceMetrics', Actual: cfg.cenableBusinessRulePerformanceMetrics, Expected: 'cenableBusinessRulePerformanceMetrics'},
  ...
  {Name: 'cenableConstantsValidation', Actual: cfg.ccenableConstantsValidation, Expected: 'enableConstantsValidation'},
  ...
  {Name: 'capplicationConstantsValidationData', Actual: cfg.capplicationConstantsValidationData, Expected: 'applicationConstantsVaidationData'},
