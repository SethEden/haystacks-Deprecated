...
export const systemConstantsValidation = [
  ...
  {Name: 'cAsynchSingular', Actual: sys.cAsynchSingular, Expected: 'AsynchSingular'},
  {Name: 'cSynchSingular', Actual: sys.cSynchSingular, Expected: 'SynchSingular'},
  ...
  {Name: 'cExportConst', Actual: sys.cExportConst, Expected: 'smuggle something'},
  ...
  {Name: 'cCtempPath', Actual: sys.cCtempPath, Expected: 'CtempPath'},
  ...
  {Name: 'cSystemConstantsPathActual', Actual: sys.cSystemConstantsPathActual, Expected: 'src/Framework/Constants/'},
  ...
  {Name: 'cDestinationResourcesPath', Actual: sys.cDestinationResourcesPath, Expected: 'BinaryResourcesPath'},
  ...
  {Name: 'ccountry_constants_js', Actual: sys.ccountry_constants_js, Expected: 'country.constants'},
