...
export const genericConstantsValidation = [
  ...
  // Boolean strings
  {Name: 'cTrue', Actual: gen.ccTrue, Expected: 'True'},
  {Name: 'cFalse', Actual: gen.ccFalse, Expected: 'False'},
  {Name: 'ctrue', Actual: gen.cctrue, Expected: 'true'},
  {Name: 'cfalse', Actual: gen.ccfalse, Expected: 'false'},
  {Name: 'cTRUE', Actual: gen.ccTRUE, Expected: 'TRUE'},
  {Name: 'cFALSE', Actual: gen.ccFALSE, Expected: 'FALSE'},
  {Name: 'cOff', Actual: gen.ccOff, Expected: 'Off'},
  {Name: 'coff', Actual: gen.ccoff, Expected: 'off'},
  {Name: 'cOFF', Actual: gen.ccOFF, Expected: 'OFF'},
  {Name: 'cyes', Actual: gen.ccyes, Expected: 'yes'},
  {Name: 'cnot', Actual: gen.ccnot, Expected: 'not'},
  {Name: 'cYes', Actual: gen.ccYes, Expected: 'Yes'},
  {Name: 'cNot', Actual: gen.ccNot, Expected: 'Not'},
  {Name: 'cYES', Actual: gen.ccYES, Expected: 'YES'},
  {Name: 'cNOT', Actual: gen.ccNOT, Expected: 'NOT'},
  {Name: 'cnotok', Actual: gen.ccnotok, Expected: 'notok'},
  {Name: 'cnotOk', Actual: gen.ccnotOk, Expected: 'notOk'},
  {Name: 'cnotOK', Actual: gen.ccnotOK, Expected: 'notOK'},
  {Name: 'cNotok', Actual: gen.ccNotok, Expected: 'Notok'},
  {Name: 'cNotOk', Actual: gen.ccNotOk, Expected: 'NotOk'},
  {Name: 'cNotOK', Actual: gen.ccNotOK, Expected: 'NotOK'},
  {Name: 'cNOTok', Actual: gen.ccNOTok, Expected: 'cok;'},
  {Name: 'cNOTOk', Actual: gen.ccNOTOk, Expected: 'cOk;'},
  {Name: 'cNOTOK', Actual: gen.ccNOTOK, Expected: 'cOK;'},
  {Name: 'cnotEql', Actual: gen.ccnotEql, Expected: 'notEql'},
  {Name: 'cnoteql', Actual: gen.ccnoteql, Expected: 'noteql'},
  {Name: 'cNotEql', Actual: gen.ccNotEql, Expected: 'NotEql'},
  {Name: 'cNoteql', Actual: gen.ccNoteql, Expected: 'Noteql'},
  {Name: 'cmax', Actual: gen.ccmax, Expected: 'max'},
  {Name: 'cMax', Actual: gen.ccMax, Expected: 'Max'},
  {Name: 'cmin', Actual: gen.ccmin, Expected: 'min'},
  {Name: 'cMin', Actual: gen.ccMin, Expected: 'Min'},
  ...
  {Name: 'cHHmmss_SSS', Actual: gen.cHHmmss_SSS, Expected: 'HHmmss_SSS'},
  {Name: 'cYYYYMMDD_HHmmss', Actual: gen.cYYYYMMDD_HHmmss, Expected: 'YYYYMMDD_HHmmss'},
  {Name: 'cYYYYMMDD_HHmmss_SSS', Actual: gen.cYYYYMMDD_HHmmss_SSS, Expected: 'YYYYMMDD_HHmmss_SSS'},
  {Name: 'cYYYY_MM_DD_HH_mm_ss_SSS', Actual: gen.cYYYY_MM_DD_HH_mm_ss_SSS, Expected: 'YYYY_MM_DD_HH_mm_ss_SSS'},
  ...
  {Name: 'cwr2', Actual: gen.cwr2, Expected: 'wr2'},
