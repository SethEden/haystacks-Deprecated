...
/**
 * @function initiaizeAllClientConstantsValidationData
 ...
 */
function initiaizeAllClientConstantsValidationData() {
  let functionName = initiaizeAllClientConstantsValidationData.name;
  ...
  allClientConstantsValidationData[sys.cConstantsValidationData][app_sys.capplicationBusinessConstantsValidation] = app_biz_cv.applicationBusinessConstantsVaidation;
...
export default {
  initiaizeAllClientConstantsValidationData
};
