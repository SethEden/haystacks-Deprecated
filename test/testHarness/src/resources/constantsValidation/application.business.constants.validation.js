...
/**
 * @function appicationBusienssConstantsValidation
 * @description Initializes the appication business rules constants validation data objects array.
 * @return {void}
 * @author Seth Hollingsead
 * @date 2022/03/22
 */
export const appicationBusinessConstantsVaidation = [
