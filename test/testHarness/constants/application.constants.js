...
export const cAppPath = bas.cForwardSlash + wr1.ctest + bas.cForwardSlash + cApplicationName + bas.cForwardSlash; // "/test/testHarness/"
...
export const cFullResourcesPath = cAppPath + cResourcesCommonPath; // /test/testHarness/resources/
